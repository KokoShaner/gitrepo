...
CREATE TABLE [HumanResources].[Department] (
		...
		[ModifiedDatess_repo]     [datetime] NOT NULL,
		[dx]                 [nchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
ALTER TABLE [HumanResources].[Department]
	...
	DEFAULT (getdate()) FOR [ModifiedDatess]
GO
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Date and time the record was last updated.', 'SCHEMA', N'HumanResources', 'TABLE', N'Department', 'COLUMN', N'ModifiedDatess'
GO
